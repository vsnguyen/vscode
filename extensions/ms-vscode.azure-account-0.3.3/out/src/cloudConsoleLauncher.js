...
function connectTerminal(ipcHandle, accessTokens, consoleUri) {
    return __awaiter(this, void 0, void 0, function* () {
        console.log('Connecting terminal...');
        for (let i = 0; i < 10; i++) {
            const response = yield initializeTerminal(accessTokens, consoleUri);
            if (response.statusCode < 200 || response.statusCode > 299) {
        ...
        yield ipc_1.sendData(ipcHandle, JSON.stringify([{ type: 'status', status: 'Disconnected' }]));
    });
}
function initializeTerminal(accessTokens, consoleUri) {
    return __awaiter(this, void 0, void 0, function* () {
...
let resizeToken = {};
function resize(accessTokens, consoleUri, termId) {
    return __awaiter(this, void 0, void 0, function* () {
