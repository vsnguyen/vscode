    ...
    (function () {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const provision = () => __awaiter(this, void 0, void 0, function* () {
                consoleUri = yield cloudConsoleLauncher_1.provisionConsole(accessToken, armEndpoint, result.userSettings, os.id);
            ...
            const consoleUris = yield cloudConsoleLauncher_1.connectTerminal(accessTokens, consoleUri, progress);
